...
const { getAll_Subjects, getSubjectById, insert_Subject, update_Subject, delete_Subject } = subjectModel;
...
const router_insert_Subject = async (req, res) => {
    try {
...
const router_getAll_Subjects = async (req, res) => {
    try {
...
const router_getSubjectById = async (req, res, next) => {
    try {
...
const router_update_Subject = async (req, res, next) => {
    try {
...
const router_delete_Subject = async (req, res) => {
    try {
        //  req.params.subjectId= (req.params as { subjectId: string }).subjectId;
