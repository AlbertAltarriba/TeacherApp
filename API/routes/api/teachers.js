...
const { getDataTeacherAndUser, updateDataTeacherAndUser, updateDataTeacherAndUser_noimage, getAll_TeachersAndUsers, getAll_TeachersAndUsers_paginacion, setdeleted_Teacher_ById } = teacherModel;
...
const router_getAll_Teachers = async function (req, res, next) {
...
const router_getAll_Teachers_paginacion = async function (req, res, next) {
    //console.log(' EL USUARIO LOGEADO EN TODA LA APP (EN MIDDLEWARE DE CHECKTOKEN):',req.user);
    try {
...
const router_getDataTeacherAndUser = async function (req, res, next) {
    // //  console.log(' EL USUARIO LOGEADO EN TODA LA APP (EN MIDDLEWARE DE CHECKTOKEN):',req.user);
...
const router_updateDataTeacherAndUser = async function (req, res, next) {
...
const router_readImageTeacher = async function (req, res, next) {
...
// });
// DELETE http://localhost:3333/api/teachers/23
const router_setdeleted_Teacher_ById = async function (req, res, next) {
