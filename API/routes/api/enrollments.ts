...
const router_getAll_enrolls:RequestHandler= async (req, res) => {
       try {
...
const router_getAll_enrolls_paginacion:RequestHandler= async (req, res) => {
  try {
   console.log('---- DENTRO de GET DE ENROLLMENTS - ------');
...
const router_insert_enrolls:RequestHandler=async (req, res) => {
  try {
...
const router_getEnrollByStudent:RequestHandler= async (req, res, next) =>{
      try {
...
const router_getEnrollByTeacher:RequestHandler= async (req, res, next) =>{
      try {
...
const router_getEnrollById:RequestHandler= async (req, res, next) =>{
  try {
...
const router_update_enrolls:RequestHandler=async (req, res, next) =>{
...
const router_setdeleted_enroll_ById:RequestHandler=async (req, res) => {
  try {
