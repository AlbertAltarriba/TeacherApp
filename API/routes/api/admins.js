...
const { getAdminByIdUser, //usada en users.js //DENTRO DE OTROS TESTEOS MAYORES
...
const router_GetAllAdmins = async (req, res, next) => {
    try {
...
const router_getDataAdminAndUser = async (req, res, next) => {
    try {
...
const router_updateDataAdminAndUser = async (req, res, next) => {
...
const router_setdeleted_admin_ById = async (req, res, next) => {
